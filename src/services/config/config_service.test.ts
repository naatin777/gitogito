...
//   const file = new ConfigFileMock({
//     project:
//       ["# AI settings", "ai:", "  default:", "    provider: Ollama # current provider", "    model: qwen3.5:9b"].join(
//         "\n",
//       ) + "\n",
//   });
//   const service = new ConfigServiceImpl(file);

//   await service.saveConfig("project", "ai.default", { provider: "Ollama", model: "qwen3.5:9b" });
...
//   const saved = await file.load("project");
//   expect(saved).toContain("model: qwen3.5:9b");
//   expect(saved).toContain("provider: Ollama");
// });
